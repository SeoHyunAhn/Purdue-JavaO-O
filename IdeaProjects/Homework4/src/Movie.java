...
public class Movie {
    ...
    public static int compareMovies(Movie movie1, Movie movie2) {
        ...
        if (movie1.criticRating > movie2.criticRating && movie1.usersRating < movie2.usersRating) {
            if (smartScore1 > smartScore2)
                ...
                return 2;
            else if(smartScore1-smartScore2<0.0001)
                return 0;
        }
        if (movie1.criticRating < movie2.criticRating && movie1.usersRating > movie2.usersRating) {
            if (smartScore1 > smartScore2)
    ...
    public static void main(String[] args) {
        ...
        Movie movie1 = new Movie(name1, criticRating1, usersRating1, numUsersRatings1);
        //Movie 2
        ...
        Movie movie2 = new Movie(name2, criticRating2, usersRating2, numUsersRatings2);
