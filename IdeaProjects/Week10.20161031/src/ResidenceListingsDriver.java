        ...
        do {
            ...
            if (mainMenuSelection == null) {
                ...
                if (residenceType.equals(residenceTypeFindSelections[0])) {
                    ...
                    boolean apartConfirm =true;
                    for (int i=0; i<rl.getResidences().length; i++){
                        if (rl.getResidences()[i]instanceof Apartment && apartConfirm==true){
                            int listing= JOptionPane.showOptionDialog(null, rl.getResidences()[i].toString(), "find a Listing", JOptionPane.YES_NO_OPTION, JOptionPane.PLAIN_MESSAGE, null, doneNextButtons, null);
                            if (listing== JOptionPane.YES_OPTION){
                                apartConfirm=false;
                            }
                        }
                    ...
                    boolean houseConfirm =true;
                    for (int i=0; i<rl.getResidences().length; i++) {
                        if (rl.getResidences()[i] instanceof House && houseConfirm == true) {
                            int listing = JOptionPane.showOptionDialog(null, rl.getResidences()[i].toString(), "find a Listing", JOptionPane.YES_NO_OPTION, JOptionPane.PLAIN_MESSAGE, null, doneNextButtons, null);
                            if (listing == JOptionPane.YES_OPTION) {
                                houseConfirm = false;
                            }
                    ...
                    boolean ResConfirm =true;
                    for (int i=0; i<rl.getResidences().length; i++) {
                        if (rl.getResidences()[i] instanceof Residence && ResConfirm == true) {
                            int listing = JOptionPane.showOptionDialog(null, rl.getResidences()[i].toString(), "find a Listing", JOptionPane.YES_NO_OPTION, JOptionPane.PLAIN_MESSAGE, null, doneNextButtons, null);
                            if (listing == JOptionPane.YES_OPTION) {
                                ResConfirm = false;
                            }
