...
public class FoilMakerController {
    ...
    String msg, requestUser, USERTOKEN, requestNewGame, GAMETOKEN, requestJoinGame, participantGame, submissionString, username,participant = "1";
